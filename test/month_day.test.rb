...
test "month day parse and validation" do
	...
	assert_equal Literal::LocalDate.new(year: 2024, month: 2, day: 29), month_day.in_year(2024)
	assert month_day.equals(month_day.with)
	assert_equal(-1, Literal::MonthDay.compare(Literal::MonthDay.new(month: 2, day: 28), month_day))
	assert_equal Literal::LocalDate.new(year: 2025, month: 2, day: 28), Literal::MonthDay.parse("--02-28").in_year(2025)
