...
test "local date time enumerator normalizes units and builds interval" do
	enumerator = Literal::LocalDateTimeEnumerator.new(
		from: Literal::LocalDateTime.new(year: 2025, month: 1, day: 13, hour: 10),
		to: Literal::LocalDateTime.new(year: 2025, month: 1, day: 14, hour: 10),
		unit: :day,
		step: 1
	)
	...
	assert_raises(ArgumentError) do
		Literal::LocalDateTimeEnumerator.new(
			from: Literal::LocalDateTime.new(year: 2025, month: 1, day: 13, hour: 10),
			to: Literal::LocalDateTime.new(year: 2025, month: 1, day: 14, hour: 10),
			unit: :day,
			step: 0
...
test "local date time enumerator yields descending values" do
	enumerator = Literal::LocalDateTimeEnumerator.new(
		from: Literal::LocalDateTime.new(year: 2025, month: 1, day: 13, hour: 14),
		to: Literal::LocalDateTime.new(year: 2025, month: 1, day: 13, hour: 10),
		unit: :hours,
		step: -2
	)
...
test "local date time enumerator returns empty when direction does not reach endpoint" do
	forward = Literal::LocalDateTimeEnumerator.new(
		from: Literal::LocalDateTime.new(year: 2025, month: 1, day: 13, hour: 14),
		to: Literal::LocalDateTime.new(year: 2025, month: 1, day: 13, hour: 10),
		unit: :hours,
		step: 1
	...
	backward = Literal::LocalDateTimeEnumerator.new(
		from: Literal::LocalDateTime.new(year: 2025, month: 1, day: 13, hour: 10),
		to: Literal::LocalDateTime.new(year: 2025, month: 1, day: 13, hour: 14),
		unit: :hours,
		step: -1
...
test "local date time enumerator month stepping works with calendar durations" do
	enumerator = Literal::LocalDateTimeEnumerator.new(
		from: Literal::LocalDateTime.new(year: 2025, month: 1, day: 1, hour: 0),
		to: Literal::LocalDateTime.new(year: 2025, month: 4, day: 1, hour: 0),
		unit: :month,
		step: 1
	)
